...
{ 
  ...
  dT =	beta*dx/cmax				hmax>=epsilon
	...
	*/
	...
	double step_export_graphic = 50; //2*60 // 4s 35 sec*24 = 840 cards -> *4 = 3360 sec 
	
	double T_export_graphic_start = 50;
	double T_export_graphic_end = 1005;
